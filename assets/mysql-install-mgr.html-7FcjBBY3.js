import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,c as p,f as a,a as s,b as e,d as o,o as c}from"./app-Cp6Zyva7.js";const r={},u={id:"_1-下载mysql",tabindex:"-1"},d={href:"https://downloads.mysql.com/archives/community/",target:"_blank",rel:"noopener noreferrer"};function m(v,n){const t=i("ExternalLinkIcon");return c(),p("div",null,[n[3]||(n[3]=a(`<h1 id="一、-初始化" tabindex="-1"><a class="header-anchor" href="#一、-初始化" aria-hidden="true">#</a> 一、 初始化</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/hosts
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="二、安装mysql服务" tabindex="-1"><a class="header-anchor" href="#二、安装mysql服务" aria-hidden="true">#</a> 二、安装mysql服务</h1>`,3)),s("h2",u,[n[1]||(n[1]=s("a",{class:"header-anchor",href:"#_1-下载mysql","aria-hidden":"true"},"#",-1)),n[2]||(n[2]=e(" 1. 下载",-1)),s("a",d,[n[0]||(n[0]=e("MYSQL",-1)),o(t)])]),n[4]||(n[4]=a(`<p>本文选择8.0.20，下载指定环境版本、安装如下文件</p><pre><code>rpm -ivh mysql-community-common-8.0.20-1.el7.x86_64.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18))])}const g=l(r,[["render",m],["__file","mysql-install-mgr.html.vue"]]);export{g as default};
