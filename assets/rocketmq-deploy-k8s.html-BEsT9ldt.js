import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as e}from"./app-bYae3XOa.js";const t={},p=e(`<h3 id="_1-k8s的yaml部署文件" tabindex="-1"><a class="header-anchor" href="#_1-k8s的yaml部署文件" aria-hidden="true">#</a> 1. K8S的yaml部署文件</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
