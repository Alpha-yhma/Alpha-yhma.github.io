import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,f as e,o as t}from"./app-Cp6Zyva7.js";const p={};function l(o,s){return t(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h2><ul><li>mig.sh</li><li>template.json</li><li>als <ul><li>env.txt</li><li>tables.txt</li></ul></li></ul><h2 id="mig-sh" tabindex="-1"><a class="header-anchor" href="#mig-sh" aria-hidden="true">#</a> mig.sh</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash  </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10)])])}const r=n(p,[["render",l],["__file","从MYSQL批量迁移数据到OceanBase.html.vue"]]);export{r as default};
