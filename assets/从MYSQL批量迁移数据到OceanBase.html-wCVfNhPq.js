import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,f as e}from"./app-3iJ96tQD.js";const t={},p=e(`<h2 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构" aria-hidden="true">#</a> 目录结构</h2><ul><li>mig.sh</li><li>template.json</li><li>als <ul><li>env.txt</li><li>tables.txt</li></ul></li></ul><h2 id="mig-sh" tabindex="-1"><a class="header-anchor" href="#mig-sh" aria-hidden="true">#</a> mig.sh</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash  </span>
